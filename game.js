...
var G = ( function () {
	...
	var COLORS = [
		PS.COLOR_YELLOW, PS.COLOR_BLUE, PS.COLOR_GREEN, PS.COLOR_ORANGE, PS.COLOR_RED
	];
	...
	return {
		init : function () {
			...
			sprite_cart = PS.spriteSolid( 3, 3 ); // Create 3x3 solid sprite, save its ID
			PS.spriteSolidColor( sprite_cart, PS.COLOR_YELLOW );
			PS.spriteSolidAlpha( sprite_cart, 128 );
			PS.spritePlane( sprite_cart, PLANE_CART ); // Set plane to 1 (above floor)
			PS.spriteMove( sprite_cart, cart_x, cart_y ); // Position sprite at center of grid
